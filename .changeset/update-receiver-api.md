...
Update receiver and virtual account types according to API reference
...
- Add `hsbc` to `BankingPartner` type
- Add optional `signed_agreement_id` to `CreateVirtualAccountInput`
