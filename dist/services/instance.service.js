...
var InstanceService = /** @class */ (function (_super) {
    ...
    function InstanceService() {
        ...
        _this.endpoint = "/instances";
        return _this;
    }
    InstanceService.prototype.createInstance = function (requestBody) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._post(this.endpoint, requestBody)];
            });
        });
    };
    InstanceService.prototype.getInstances = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._get(this.endpoint)];
            });
        });
    };
